...
public class Sistema extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        no_caja.setText("0");
        no_caja.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                no_cajaActionPerformed(evt);
            }
        });
        ...
        RecopiladorLayout.setHorizontalGroup(
            ...
            .addGroup(RecopiladorLayout.createSequentialGroup()
                ...
                .addGroup(RecopiladorLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(Estado_rec, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addGroup(RecopiladorLayout.createSequentialGroup()
        ...
        id_pres.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                id_presActionPerformed(evt);
            }
        });
        ...
        if (tipo_doc1.getSelectedItem() == "Seleccione" || dep1.getSelectedItem() == "Seleccione") {
            ...
            try {
                ...
                while (resultado.next()) {
                    ...
                    bandera = true;
                    //Bucle que recorre la consulta obtenida
                    Datos[0] = String.valueOf(resultado.getInt("id_pres"));

                    switch (resultado.getInt("id_dep")) {
                        case 1:
                    ...
                    Datos[4] = String.valueOf(resultado.getDate("fecha_prestamo"));

                    if ("1000-01-01" == String.valueOf(resultado.getDate("fecha_entrega"))) {
                        System.out.println("holishere");
                        Datos[5] = "----/--/--";
                    } else {
                        Datos[5] = String.valueOf(resultado.getDate("fecha_entrega"));
                    }

                    if (aux_pres.getTipo() == 1) {
                        Datos[6] = String.valueOf(resultado.getInt("folio_inicial"));
                    } else {
                        Datos[6] = String.valueOf(resultado.getInt("id_fac"));
                    }
                    tabla1.addRow(Datos);
    ...
    private void id_presActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_id_presActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_id_presActionPerformed
        ...
        if (tipo1.getSelectedItem() == "Seleccione") {
            ...
            try {
                while (resultado.next()) {
                    ...
                    aux_fac.setId(resultado.getInt("id"));
                    aux_fac.setId_fac(resultado.getInt("id_fac"));
                    aux_fac.setProveedor(resultado.getInt("proveedor"));
                    aux_fac.setEstado(resultado.getInt("estado"));
                    Datos[0] = String.valueOf(aux_fac.getId());
                    Datos[1] = String.valueOf(aux_fac.getId_fac());
                    ...
                    Datos[3] = String.valueOf(aux_fac.getProveedor());
...
//Agregar recopilador
    ...
    private void no_cajaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_no_cajaActionPerformed

    }//GEN-LAST:event_no_cajaActionPerformed
